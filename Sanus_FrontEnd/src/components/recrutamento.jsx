...
export default function Recrutamento() {
  ...
  return (
    <section className="sanus-recrutamento" id="localizacao">
        ...
        <svg class="sanus-recruitment-wave" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="rgba(195, 232, 219)" fill-opacity="1" d="M0,128L120,138.7C240,149,480,171,720,170.7C960,171,1200,149,1320,138.7L1440,128L1440,0L1320,0C1200,0,960,0,720,0C480,0,240,0,120,0L0,0Z"></path></svg>
    </section>
  )
}