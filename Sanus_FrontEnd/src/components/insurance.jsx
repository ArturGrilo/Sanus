...
export default function Insurance() {
  return (
    <section className="sanus-insurance-main">
      <svg className="sanus-insurance-wave-top" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="var(--color-primary-dark)" fillOpacity="1" d="M0,160L80,186.7C160,213,320,267,480,266.7C640,267,800,213,960,197.3C1120,181,1280,203,1360,213.3L1440,224L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path></svg>
      <section className="sanus-insurance">
        <section className="sanus-insurance-sub">
          <svg className="sanus-pattern alt" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id="pattern-fisio" width="40" height="40" patternTransform="scale(2)" patternUnits="userSpaceOnUse">
                ...
                <path fill="none" stroke="var(--color-other)" strokeLinecap="square" d="M20-5V5m0 30v10m20-30v10M0 15v10"/>
          ...
          <div className="sanus-insurance-container">
            <div className="sanus-insurance-sub-container">
              <header className="sanus-general-title alt">
                <p className="sanus-services-text little alt">Cobertura de cuidados de saúde</p>
      ...
      <svg className="sanus-insurance-wave" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="var(--color-primary-dark)" fillOpacity="1" d="M0,128L120,138.7C240,149,480,171,720,170.7C960,171,1200,149,1320,138.7L1440,128L1440,0L1320,0C1200,0,960,0,720,0C480,0,240,0,120,0L0,0Z"></path></svg>
    </section>
  );
}